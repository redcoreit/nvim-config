...
map("n", "<leader>hw", ":lua require('harpoon.ui').toggle_quick_menu()<CR>", opts)
map("n", "<C-a>", ":lua require('harpoon.ui').nav_file(1)<CR>", opts)
map("n", "<C-s>", ":lua require('harpoon.ui').nav_file(2)<CR>", opts)
map("n", "<C-f>", ":lua require('harpoon.ui').nav_file(3)<CR>", opts)
map("n", "<C-g>", ":lua require('harpoon.ui').nav_file(4)<CR>", opts)
--map("n", "<C-g><C-a>", ":lua require('harpoon.ui').nav_file(4)<CR>", opts)
--map("n", "<C-g><C-s>", ":lua require('harpoon.ui').nav_file(5)<CR>", opts)
--map("n", "<C-g><C-s>", ":lua require('harpoon.ui').nav_file(6)<CR>", opts)
